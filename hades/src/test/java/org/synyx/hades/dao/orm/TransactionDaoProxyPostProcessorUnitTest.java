...
/**
 * Unit test for {@link TransactionalDaoProxyPostProcessor}.
 * 
 * @author Oliver Gierke
 */
@RunWith(MockitoJUnitRunner.class)
public class TransactionDaoProxyPostProcessorUnitTest {

    TransactionalDaoProxyPostProcessor processor;
    ...
    public void rejectsNullBeanFactory() throws Exception {
        ...
        new TransactionalDaoProxyPostProcessor(null, "transactionManager");
    }
    ...
    public void rejectsNullTxManagerName() throws Exception {
        ...
        new TransactionalDaoProxyPostProcessor(beanFactory, null);
    }
    ...
    public void setsUpBasicInstance() throws Exception {
        ...
        DaoProxyPostProcessor postProcessor =
                new TransactionalDaoProxyPostProcessor(beanFactory, "txManager");
