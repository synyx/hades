...
import org.synyx.hades.domain.auditing.support.AuditingBeanFactoryPostProcessor;
 ...
 */
public class AuditingBeanFactoryPostProcessorUnitTest {
    ...
    public void setUp() {
        ...
        beanFactory =
                new XmlBeanFactory(new ClassPathResource(getConfigFile()));
