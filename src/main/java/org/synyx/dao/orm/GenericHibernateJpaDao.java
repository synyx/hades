...
import org.synyx.dao.ExtendedGenericDao;
 ...
 */
public class GenericHibernateJpaDao<T extends Identifyable<PK>, PK extends Serializable>
     ...
     * (non-Javadoc)
     * 
     * @see org.synyx.dao.ExtendedGenericDao#readByExample(org.synyx.domain.Identifyable)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.synyx.dao.ExtendedGenericDao#readbyExample(java.awt.print.Pageable,
     *      T[])
     */
